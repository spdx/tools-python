...
class GenPythonModelFromSpec:
    ...
    def handle_vocab(self, vocab: dict, namespace_name: str):
        ...
        with open(file_path, "w") as output_file:
            output_file.write(VOCAB_FILE.format(typename=typename, values=values_text, values_to_str=values_to_str_text,
                                                str_to_values=str_to_values_text, python_typename=python_typename,
                                                docstring=docstring))
