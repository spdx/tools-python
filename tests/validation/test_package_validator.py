...
from src.validation.package_validator import validate_package
...
def test_valid_package():
    ...
    validation_messages: List[ValidationMessage] = validate_package(package, get_document())
...
def test_invalid_package(package_input, expected_message):
    validation_messages: List[ValidationMessage] = validate_package(package_input, get_document())
