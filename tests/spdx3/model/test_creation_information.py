...
def test_invalid_initialization():
    ...
    assert err.value.args[0] == ['SetterError CreationInformation: type of argument "spec_version" must be '
                                 ...
                                 'SetterError CreationInformation: type of argument "profile" must be a list; '
                                 'got str instead: core',
                                 'SetterError CreationInformation: type of argument "data_license" must be '
                                 'str; got int instead: 3']
...
def test_incomplete_initialization():
    ...
    assert "__init__() missing 4 required positional arguments: 'created', 'created_by', 'created_using', and 'profile'" in \
           err.value.args[0]
