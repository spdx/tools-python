...
def write_snippet(snippet: Snippet, output_text: TextIO):
    ...
    write_text_value("SnippetCopyrightText", snippet.copyright_text, output_text, True)
    write_range("SnippetByteRange", snippet.byte_range, output_text)
    write_range("SnippetLineRange", snippet.line_range, output_text, True)
    write_value("SnippetName", snippet.name, output_text, True)
    write_text_value("SnippetComment", snippet.comment, output_text, True)
    write_text_value("SnippetLicenseComments", snippet.license_comment, output_text, True)
    for attribution_text in snippet.attribution_texts:
        write_text_value("SnippetAttributionText", attribution_text, output_text)
    write_field_or_none_or_no_assertion("SnippetLicenseConcluded", snippet.concluded_license, output_text, True)
    write_field_or_none_or_no_assertion("LicenseInfoInSnippet", snippet.license_info_in_snippet, output_text, True)
