...
class ExtractedLicensingInfoParser:
    ...
    @staticmethod
    def parse_extracted_licensing_info_name(extracted_licensing_info_name_or_no_assert) -> Union[
        str, SpdxNoAssertion]:
        if extracted_licensing_info_name_or_no_assert == SpdxNoAssertion().__str__():
            return SpdxNoAssertion()
        else:
            return extracted_licensing_info_name_or_no_assert
