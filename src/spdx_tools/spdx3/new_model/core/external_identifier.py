...
from ..core.external_identifier_type import ExternalIdentifierType


@dataclass_with_properties
class ExternalIdentifier(ABC):
    """
    An ExternalIdentifier is a reference to a resource outside the scope of SPDX-3.0 content that uniquely identifies
    an Element.
    """

    external_identifier_type: ExternalIdentifierType = None
    """
