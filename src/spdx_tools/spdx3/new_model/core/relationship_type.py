...
class RelationshipType(Enum):
    ...
    """
    Every `to` Element is a dependency not included in the distributed artifact but is assumed to be provided the `from`
    Element
    """
    PUBLISHED_BY = auto()
    """
    ...
    REPORTED_BY = auto()
    """
    (Security) Designates the agent that first reported a vulnerability to the project, vendor, or tracking database for
