...
class VexVulnAssessmentRelationship(VulnAssessmentRelationship):
    ...
    **Constraints**
    ...
    can be completed by reading the equivalent field from the containing document. For example, if a VEX relationship
    is missing data in its createdBy property, tools must consider the entity listed in the CreationInfo section of the
