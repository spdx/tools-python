...
from ..security.vex_justification_type import VexJustificationType
...
class VexNotAffectedVulnAssessmentRelationship(VexVulnAssessmentRelationship):
    ...
    **Constraints**
    ...
    When linking elements using a VexNotVulnAffectedAssessmentRelationship, the following requirements must be
    observed:
    ...
    * Both impactStatement and justificationType properties have a cardinality of 0..1 making them optional.
      Nevertheless, to produce a valid VEX not_affected statement, one of them MUST be defined. This is specified in
      the Minimum Elements for VEX.
