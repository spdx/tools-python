...
class VexAffectedVulnAssessmentRelationship(VexVulnAssessmentRelationship):
    ...
    **Syntax**
    ...
    """
    When a VEX statement communicates an affected status, the author MUST include an action statement with a
    recommended action to help mitigate the vulnerability's impact. The actionStatementTime property records the time
