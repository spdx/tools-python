...
from spdx_tools.spdx3.writer.console.core.creation_info_writer import write_creation_info
from spdx_tools.spdx3.writer.console.core.external_identifier_writer import write_external_identifier
from spdx_tools.spdx3.writer.console.core.external_reference_writer import write_external_reference
