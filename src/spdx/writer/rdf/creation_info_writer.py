...
def add_creation_info_to_graph(creation_info: CreationInfo, graph: Graph):
    ...
    add_literal_value_if_exists(graph, doc_node, RDFS.comment, creation_info.document_comment)
    ...
    add_literal_value_if_exists(graph, creation_info_node, RDFS.comment, creation_info.creator_comment)
